...
<section class="big-background">
   <?php include("background1.php"); ?>
   <div class="big-background-container">
      <h1 class="big-background-title" style="margin: 0">Platformer</h1>
      <h1 id="colorize" style="margin: 0; margin-top: 20px">Developed by Group:</h1>
      <img src="images/Logo.png" style="height: 100%; width: 100%; opacity: 0.4">
